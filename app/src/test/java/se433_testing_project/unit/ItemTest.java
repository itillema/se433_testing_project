...
class ItemTest {
    ...
    void constructsWithValidValues() {
        ...
        assertEquals(2.50, item.getPrice(), 1e-9);
    ...
    void getSubtotalMultipliesPriceByQuantity() {
        assertEquals(7.50, new Item("Pen", 2.50, 3).getSubtotal(), 1e-9);
    }
    ...
    void setQuantityUpdatesValueAndSubtotal() {
        ...
        assertEquals(12.50, item.getSubtotal(), 1e-9);
    }
